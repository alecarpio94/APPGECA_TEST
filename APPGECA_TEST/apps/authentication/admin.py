...
class User(UserAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('ci', 'first_name', 'last_name', 'email','is_secretaria','is_profesor','is_alumno')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username' ,'ci', 'first_name', 'last_name', 'email','is_secretaria', 'is_profesor','is_alumno','password1', 'password2'),
        }),
    )