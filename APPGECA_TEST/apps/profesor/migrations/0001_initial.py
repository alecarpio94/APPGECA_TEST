...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Evaluado',
            fields=[
                ('profesor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='profesor.Profesor')),
        ...
        migrations.AddField(
            model_name='evaluado',
            name='asignados',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='profesor.Asignados'),
        ),
    ]
